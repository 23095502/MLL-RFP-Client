export class RFPDetailsController {
  constructor($http) {
    ...
    //GET SERVICETYPE
     ...
     //GET VEHICLETYPE
    //this.isVEHICLETYPENAME_option = _.map(['INDICA', 'B', 'C'], (i) => ({ name : i, val : i}));
    //GET SERVICETYPE

   //GET PACKAGINGTYPE
    this.isPACKAGETYPEID_option = _.map(['Pallet', 'Corrugated Boxes', 'Bags','Trolley', 'Loose'], (i) => ({ name : i, val : i}));
    //GETPACKAGINGTYPE
    //GET
